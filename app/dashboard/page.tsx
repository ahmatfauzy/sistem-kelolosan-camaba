...
import { Upload, Download, Plus, Save, Edit, Trash2, FileDown } from "lucide-react"
...
export default function DashboardPage() {
  ...
  const fetchRanking = useCallback(async () => {
    ...
    try {
      // Menggunakan view yang benar sesuai dengan schema database
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Dashboard SPK Kelolosan Camaba</h1>
        <p className="text-gray-600">Kelola periode, kriteria dinamis, dan lihat ranking calon mahasiswa</p>
      </div>
      ...
      <Tabs defaultValue="periode" className="space-y-6">
        ...
        <TabsContent value="mahasiswa" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Impor data dari Excel atau tambah manual</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex gap-4 items-center flex-wrap">
                          ...
                          {kriteria.map((k) => (
                            <div key={k.id_kriteria} className="space-y-1">
                              ...
                              <Input
                                ...
                                step="0.01"
                                min="0"
                                value={newMahasiswa.penilaian.find((p) => p.id_kriteria === k.id_kriteria)?.nilai || 0}
                ...
                {/* <Button variant="outline" onClick={handleExportTemplate} disabled={kriteria.length === 0}>
        ...
        <TabsContent value="ranking" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <div className="flex justify-between items-center mb-6">
                <div className="text-sm text-gray-600">Total Kandidat: {ranking.length}</div>
              ...
              {ranking.length === 0 && (
                <div className="text-center py-8 text-gray-500">
                  Belum ada data ranking. Pastikan ada data mahasiswa dan kriteria yang valid untuk menghitung ranking.
                </div>
              )}
            </CardContent>
          </Card>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                  ...
                  <div className="p-4 bg-green-50 rounded-lg">
                    <div className="text-2xl font-bold text-green-600">
                      {ranking.filter((r) => r.peringkat <= 10).length}
                    </div>
